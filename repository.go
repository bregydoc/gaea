...
type Repository interface {
	...
	GetPersonByMongoID(c context.Context, id interface{}) (*Person, error)
	...
	GetAccountByMongoID(c context.Context, id interface{}) (*Account, error)
	...
	GetSessionByMongoID(c context.Context, id interface{}) (*Session, error)
